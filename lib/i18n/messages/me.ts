...
export const meMessages: Messages = {
    pagination: {
      previous: "Prethodna",
      next: "Sljedeća",
    ...
    research: {
      ...
      results: {
        ...
        excerptDisclaimer:
          "Odlomak iz teksta zakona — može biti presječen. Nije službeni prečišćeni tekst.",
      ...
      features: {
        ...
        items: {
          ...
          research: {
            title: "Pravno istraživanje",
            description:
              "Pretražite propise i pravnu bazu kroz balkanske jurisdikcije uz ocjene relevantnosti. Sačuvajte istraživanja i gradite argumente sa citiranim lokalnim izvorima.",
          },
          matters: {
            title: "Upravljanje predmetima",
            description:
              "Organizujte rad po predmetima i držite ugovore, rokove, vrijeme i naplatu na jednom mjestu. Pratite status od prijema do zatvaranja bez mijenjanja alata.",
          },
          templates: {
    ...
    dashboard: {
      ...
      actions: {
        ...
        predict: {
          ...
          description:
            "Legantis analiza ishoda na osnovu prakse i prava.",
        },
        clients: {
          title: "Klijenti",
          description:
    ...
    deadlines: {
      ...
      testReminder: {
        ...
        failed: "Pokretanje probnih podsetnika nije uspjelo",
      },
      dialog: {
        titleNew: "Novi rok",
        titleEdit: "Uredi rok",
      ...
      calendar: {
        ...
        legend: {
          preclusive: "Prekluzivni rok — ne smije se propustiti",
          record: "Evidencija",
        },
      },
    },
    generate: {
      ...
      fields: {
        ...
        tenantName: "Zakupac",
        principalName: "Ime punomoćnika (mandant)",
        agentName: "Ime punomoćnika (zastupnik)",
        scopeOfAuthority: "Opseg ovlašćenja",
    ...
    predictions: {
      ...
      result: {
        ...
        subtitle:
          "Kvalitativna procjena ishoda, ključni faktori, presedani, preporuke i rizici na osnovu unesenih informacija.",
        downloadPdf: "Preuzmi PDF",
        saved: "Predviđanje je sačuvano u radni prostor.",
        empty:
          "Vaše predviđanje će se pojaviti ovdje nakon analize. Vidjećete kvalitativnu procjenu ishoda, nivo pouzdanosti, ključne faktore, relevantne presedane, preporuke i rizike, uz odricanje odgovornosti.",
      ...
      similarCases: {
        ...
        plaintiffWinRate:
          "Od {n} pronađenih odluka, {pct}% je odlučeno u korist tužioca",
        insufficient:
          "Nema dovoljno uporedivih odluka s poznatim ishodom da bismo prikazali omjer.",
        noWinRate:
          "Pronađene odluke su djelimične ili procesne i ne podržavaju omjer pobjeda.",
        ...
        signalRisky: "Više odluka u korist tuženog",
      },
      disclaimer: {
        title: "ODRICANJE ODGOVORNOSTI",
        body:
          "Legantis je u aktivnom razvoju. Ova analiza je informativnog karaktera i ne zamjenjuje stručnu pravnu procjenu niti pravni savjet. Pružalac usluge ne preuzima odgovornost za odluke donesene na osnovu ovog sadržaja.",
      },
      caseTypes: {
