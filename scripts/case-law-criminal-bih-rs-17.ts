// scripts/case-law-criminal-bih-rs-17.ts
// BiH RS — krivična djela protiv bezbjednosti računarskih podataka.
// Auto-generated from downloads/bih-rs/krivicno/krivicna-djela-protiv-bezbjednosti-racunarskih-podataka/ (1 cases, 1 PDFs)

import type { CaseLawInput } from "./ingest-case-law"

export const CASE_LAW_CRIMINAL_BIH_RS_17: CaseLawInput[] = [{
      jurisdiction: "bih_rs",
      court: "Vrhovni sud Republike Srpske",
      court_level: "supreme",
      case_number: "95_0_K_015612_12_Kvlz",
