...
export function createBrckoUpravnoGenerator(cfg) {
  ...
  function summarize(full, iz) {
    ...
    const reasoning = cleanSnippet(
      `Sud ocjenjuje tužbu, žalbu ili drugi pravni lijek u upravnom sporu iz oblasti ${title}, primjenjujući ${statuteLabel} i Zakon o upravnim sporovima Brčko Distrikta BiH (ZUS Brčko). ${full.slice(0, 1400).replace(/\s+/g, " ").slice(0, 550)}`,
      900,
    )
    return {
