...
function summarizeNumbered(full, izrekaCyr) {
  ...
  const dq = orgCrimeLegalQuestion(lat)
  ...
  const reasoning =
    "Sud ocjenjuje žalbene ili ZZL prigovore u predmetima organizovanog kriminala, uključujući udruživanje za vršenje krivičnih djela (čl. 250. i dr. KZ RS), stićaj i uloge u kriminalnoj organizaciji, te postupovne povrede iz čl. 311. i 350–356. ZKOP RS."
